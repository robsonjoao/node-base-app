...
var AbstractCrud = require('./abstract-crud');
...
app.loadCloudConfig = function() {
	...
	console.log('config server: ' + localConf.get('cloud-config.uri'));
...
exports.AbstractCrud = function(route, args) {
	args.service = Service;
	return AbstractCrud(route, args)
	//var crud = AbstractCrud({service: Service, route: args.route, serviceName: args.service, resourcePath: args.resourcePath});
	//return crud;
	/*
	return {
		teste: 'teste'
